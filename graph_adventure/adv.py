...
# init a traversal graph as an empty dict
...
while len(visited) < 500:
    ...
    if unexplored_exits:
        ...
        move = random.choice(unexplored_exits)
        ...
        traversalGraph[player.currentRoom.id][reverse_directions[move]] = previous_room_id
    else:
        queue = deque()
        queue.append(list(reverse_directions[traversalPath[-1]]))
        path_creation = True
       # print(f"Reached dead end: {player.currentRoom.id}")
        # walk backwards
        while path_creation:
            ...
            for exit in exits:
                ...
                elif reverse_directions[exit] != last_move:
            ...
            if path_creation:
                for r_move in dequeued[::-1]:
                    player.travel(reverse_directions[r_move])
            else:
                # shortest path
                traversalPath.extend(dequeued)
           # print(fßPlayer after reset: {player.currentRoom.id}")
